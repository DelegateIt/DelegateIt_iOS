...
function scene:create( event )
   ...
   local background = display.newRect(sceneGroup,myData.width/2,myData.height/2, myData.width, myData.height)
   ...
   menuText = display.newText(sceneGroup,"REGISTER", myData.width*.5, myData.height*.055, "Prelo-Bold", myData.width/18)
